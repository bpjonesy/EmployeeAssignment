...
public class Payroll {
    ...
    private void populateEmployees() {
       ...
       String enterAnother = "N";

        do {

            System.out.println("Please enter details for employee " + (employees.length + 1) + ":");
            ...
            if (e != null) {
                ...
                System.out.println(e.getFirstName() + " " + e.getLastName() + " has been added");
                System.out.println("Would you like to enter another? (Y/N)");
                enterAnother = new Scanner(System.in).nextLine();
            } else {
                continue;
            }
